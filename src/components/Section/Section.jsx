        ...
        <section className=" bg-gray-100">
                <div className="text-center py-28 ">
                    ...
                    <div className="flex flex-col items-center px-3 mb-12  lg:mb-0">
                        <img className="w-48 h-48 rounded-full mb-4" src="https://startbootstrap.github.io/startbootstrap-landing-page/assets/img/testimonials-1.jpg"/>
                        <div>
                    ...
                    {/*avatar 2*/}
                    <div className="flex flex-col items-center px-3 mb-12 lg:mb-0">
                        <img className="w-48 h-48 rounded-full mb-4" src="https://startbootstrap.github.io/startbootstrap-landing-page/assets/img/testimonials-2.jpg"/>
                        <div>
                    ...
                    {/*avatar 3*/}
                    <div className="flex flex-col items-center px-3 mb-12 lg:mb-0 ">
                        <img className="w-48 h-48 rounded-full mb-4" src="https://startbootstrap.github.io/startbootstrap-landing-page/assets/img/testimonials-3.jpg"/>
                        <div>
